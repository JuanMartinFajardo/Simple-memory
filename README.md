...
So I downloaded a software to simulate circuits. I chose one called 'Digital', developed by Helmut Neemann (you can download it at https://github.com/hneemann/Digital).

I designed a memory of 64 'bytes', where this 'byte' was made out of 6 bits instead of 8 (I was bored but the summertime was finite). So each byte can store a number between 0 and 63.
